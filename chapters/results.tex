...
\label{sec:experimental_results}
	...
	\begin{table}[!htdp]
		...
		\botapic[0.45]{no_propagation_graph}{Pheromone distribution without pheromone propagation in the final iteration of the optimization of a Morse cluster with 50.}
		\botapic[0.45]{propagation_graph}{Pheromone distribution with pheromone propagation in the final iteration of the optimization of a Morse cluster with 50.}
		...
		\begin{table}[!htdp]
				...
				\end{center}
		\end{table}
		\botapic[0.4]{no_prop_vs_prop_mbf_50}{Evolution of the MBF of DACCO with and without pheromone propagation. Results were obtained with the Morse instance with 50 atoms.}
